...
import type { FooterData, ContactInfo } from '@/lib/firestore';
...
export const Footer = ({ footerData = defaultFooter, contactInfo }: FooterProps) => {
            ...
            <div className="flex gap-3">
              {contactInfo.socialLinks.map((link) => (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-muted hover:bg-primary/20 flex items-center justify-center text-muted-foreground hover:text-primary transition-all"
                >
