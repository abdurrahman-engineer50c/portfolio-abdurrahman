...
const defaultExperiences: Experience[] = [
  {
    ...
    description: 'Led the development of industrial IoT solutions for manufacturing automation. Designed and implemented sensor networks, real-time monitoring systems, and predictive maintenance algorithms.',
    startDate: '2022-01',
    current: true,
    published: true,
    order: 1,
  },
  {
    ...
    description: 'Developed firmware for ESP32 and STM32-based products. Created communication protocols for BLE and WiFi connectivity. Integrated cloud platforms for data analytics.',
    startDate: '2020-03',
    endDate: '2021-12',
    current: false,
    published: true,
  ...
  },
  {
    ...
    description: 'Designed PCB layouts for IoT devices. Prototyped and tested embedded systems. Collaborated with software teams for firmware-hardware integration.',
    startDate: '2018-06',
    endDate: '2020-02',
    current: false,
    published: true,
